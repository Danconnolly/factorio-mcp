...
function read_only.capability_contract(character)
  ...
  return {
    ...
    capabilities = { "get_capability_contract", "get_actor_status", "scan_local", "scan_charted", "get_entity", "get_action_record", "walk_to", "stop", "mine", "craft", "get_action" },
  }
end
...
function read_only.get_action_record(request)
  ...
  local records = storage.factorio_agent_bridge.audit_records
