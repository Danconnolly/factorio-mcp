...
async fn bridge_version_mismatch_fails_closed() {
    let mismatched =
        contract_response().replace("\"bridge_build\":\"0.2.0\"", "\"bridge_build\":\"0.2.1\"");
